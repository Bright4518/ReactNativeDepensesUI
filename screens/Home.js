...
const Home = () => {
            ...
            expenses: [
                {
                    ...
                    location: "ABPI&CONSULTING' tuition center",
                    total: 100.00,
                ...
                },
                {
                    ...
                    location: "ABPI&CONSULTING' Book Store",
                    total: 20.00,
            ...
            expenses: [
                {
                    ...
                    title: "Vitamins",
                    description: "Vitamin",
                    location: "ABPI&CONSULTING' Pharmacy",
                    total: 25.00,
                    status: pendingStatus,
                },
            ...
            expenses: [
                {
                    ...
                    title: "Toys",
                    description: "toys",
                    location: "ABPI&CONSULTING' Toy Store",
                    total: 25.00,
                    status: confirmStatus,
                },
                {
                    ...
                    location: "ABPI&CONSULTING' Baby Care Store",
                    total: 100.00,
                    status: pendingStatus,
                },
                {
                    ...
                    title: "Pampers",
                    description: "Pampers",
                    location: "ABPI&CONSULTING' Supermarket",
                    total: 100.00,
                    status: pendingStatus,
                },
                {
                    ...
                    title: "Baby T-Shirt",
                    description: "T-Shirt",
                    location: "ABPI&CONSULTING' Fashion Store",
                    total: 20.00,
                    status: pendingStatus,
                },
            ],
    ...
    function renderCategoryHeaderSection() {
        return (
            ...
            justifyContent:'space-between',alignItems:'center'}}>
                {/* Title */}
                <View>
                    <Text style={{color:COLORS.primary,...FONTS.h3}}>CATEROGIES</Text>
    ...
    function renderIncomingExpensesTitle() {
        return (
            <View style={{padding:SIZES.padding,backgroundColor:COLORS.lightGray2}}>
                <Text style={{...FONTS.h3,color:COLORS.primary}}>INCOMMING EXPENSES</Text>
                <Text style={{...FONTS.h4,color:COLORS.darkgray}}>12 Total</Text>
    ...
    function processCategoryDataToDisplay() {
        //Filter expenses with "Confirmed"
        ...
        //Calculatrice the total expenses
        let totalExpense = filterChartData.reduce((a, b) => a + (b.y || 0), 0)
        
        //Calculatrice percentage and repopulate chart data
            ...
            return (
                ...
                >
                    ...
                    <View style={{justifyContent:'center'}}>
                        <Text style={{...FONTS.h3, color:(selectedCategory&& selectedCategory.name==item.name)?COLORS.white:COLORS.primary}}>{item.y} USD - { item.label}</Text>
                    </View>
